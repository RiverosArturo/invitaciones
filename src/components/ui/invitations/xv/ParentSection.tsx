  ...
  return (
    ...
    >
      ...
      <div className="relative w-full z-10">
        <div
          ref={cardRef}
          className={`relative mx-auto max-w-5xl px-8 pt-6 pb-16 text-center bg-gradient-to-b from-purple-300 to-purple-50 rounded-b-full shadow-xl transition-opacity duration-300 ${
