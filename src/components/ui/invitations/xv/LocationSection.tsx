...
export const LocationsSection = ({ locations }: LocationsSectionProps) => {
  ...
  return (
    <section
      ref={sectionRef}
      id="ceremonia"
      className="relative isolate px-4 overflow-hidden bg-gradient-to-b from-purple-100 to-purple-300 pb-10"
    >
      {/* Canvas por encima del blur, pero sin interferir con click/touch */}
      <div className="absolute inset-0 pointer-events-none z-20">
        <SparklesF />
      </div>

      {/* Contenido normal debajo del canvas (z-10) */}
